...
import com.crowd.curtain.interceptor.TokenInterceptor;
...
public class App extends Application {
    ...
    private void initConfigs(){
        BaseUtil.initContext(mApplication);
        List<Interceptor> interceptors = new ArrayList<>();
        interceptors.add(new TokenInterceptor());
        HttpClient.initOkHttpClient(interceptors);
        ServerConfig.initserver();
        UMConfigure.init(this,UMConfigure.DEVICE_TYPE_PHONE, AppConfig.UMENG_SECRET);
